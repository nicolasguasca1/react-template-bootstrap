          ...
          <div className="d-flex align-items-center">
            <Navbar.Collapse id="navbar-default-primary">
              <Nav className="navbar-nav-hover align-items-lg-center">
                <Nav.Link as={HashLink} to="dashboard/overview">
                  Explorar Dashboard
                </Nav.Link>
                  ...
                  <Carousel className="container p-5">
                    <Carousel.Item interval={3000}>
                      ...
                      <Carousel.Caption className="text-end">
                        ...
                        <p>
                          Utiliza nuestras rutas para llevar tus productos en el
                    ...
                    <Carousel.Item interval={3000}>
                      ...
                      <Carousel.Caption className="text-end">
                        ...
                        <p>
                          Te damos las herramientas para que puedas ver la
                          evolución de tus órdenes en tiempo real
                        </p>
                      </Carousel.Caption>
                    </Carousel.Item>
                  </Carousel>
